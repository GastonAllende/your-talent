...
(function(W, N, r) {
  ...
  function q(b, a, c) {
    ...
    if (b)
      if (A(b))
        for (d in b)
          "prototype" != d &&
            "length" != d && "name" != d && b.hasOwnProperty(d) &&
            a.call(c, b[d], d);
      else if (b.forEach && b.forEach !== q) b.forEach(a, c);
      else if (pb(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
  ...
  function Rb(b, a) {
    return w(new (w(function() {}, { prototype: b }))(), a);
  }
  function s() {}
  function Ba(b) {
    return b;
  ...
  function ga(b, a) {
    ...
    if (a) {
      if (b === a) throw Na("cpi");
      if (L(b))
        for (var c = (a.length = 0); c < b.length; c++) a.push(ga(b[c]));
      else {
        c = a.$$hashKey;
        q(a, function(b, c) {
          delete a[c];
  ...
  function Sb() {
    return (
      (N.securityPolicy && N.securityPolicy.isActive) ||
      (N.querySelector &&
        !(!N.querySelector("[ng-csp]") && !N.querySelector("[data-ng-csp]")))
    );
  }
  function rb(b, a) {
    var c = 2 < arguments.length ? ua.call(arguments, 2) : [];
    return !A(a) || a instanceof RegExp
      ? a
      : c.length
      ? function() {
          return arguments.length
            ? a.apply(b, c.concat(ua.call(arguments, 0)))
            : a.apply(b, c);
        }
      : function() {
  ...
  function Zb(b, a) {
    ...
    d &&
      (a
        ? delete Sa[c].data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), $b(b)),
          delete Sa[c],
          (b[db] = r)));
  }
  function ka(b, a, c) {
    var d = b[db],
      d = Sa[d || -1];
    if (z(c)) d || ((b[db] = d = ++Xc), (d = Sa[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function ac(b, a, c) {
    var d = ka(b, "data"),
  ...
  function fc(b) {
    ...
    "function" == typeof b
      ? (a = b.$inject) ||
        ((a = []),
        b.length &&
          ((c = b.toString().replace(Zc, "")),
          (c = c.match($c)),
          q(c[1].split(ad), function(b) {
        ...
        (b.$inject = a))
      : L(b)
      ? ((c = b.length - 1), Qa(b[c], "fn"), (a = b.slice(0, c)))
      : Qa(b, "fn", !0);
    return a;
  }
  function Yb(b) {
      ...
      q(a, function(a) {
        if (!k.get(a)) {
          ...
          try {
            ...
            m.message &&
              m.stack && -1 == m.stack.indexOf(m.message) &&
              (m = m.message + "\n" + m.stack),
            Ua("modulerr", a, m.stack || m.message || m));
          }
        }
      });
      return b;
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (m.pushState(null, "", a), Z.attr("href", Z.attr("href")))
              : ((y = a), c ? k.replace(a) : (k.href = a)),
            h
          );
    ...
    h.cookies = function(a, b) {
      ...
      if (a)
        b === r
          ...
          : D(b) &&
            ((d =
              (l.cookie = escape(a) + "=" + escape(b) + ";path=" + $).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[g]),
              ...
              0 < h &&
                ...
                Y[a] === r && (Y[a] = unescape(e.substring(h + 1))));
        return Y;
      }
    };
  ...
  function hc(b, a) {
    ...
    this.$get = [
      ...
      "$animate",
      "$$sanitizeUri",
      function(a, b, m, n, p, t, C, B, K, u, P, Z) {
          ...
          function f(a, c, d, e) {
            ...
            for (t = k.length; n < t; C++)
              (l = da[C]),
                ...
                c
                  ? (c.scope
                      ? ((p = a.$new()), m.data("$scope", p), ba(m, "ng-scope"))
                      : (p = a),
                    (m = c.transclude) || (!e && b)
                      ? c(g, p, l, d, Y(a, m || b))
                      : c(g, p, l, d, e))
                  : g && g(a, l.childNodes, r, e);
          }
          for (var k = [], l, m, p, n = 0; n < a.length; n++)
            (m = new Eb()),
              (l = X(a[n], [], m, 0 === n ? d : r, e)),
              (l =
                ((g = l.length ? M(l, a[n], m, b, c, null, [], [], g) : null) &&
                  g.terminal) ||
                !a[n].childNodes ||
                !a[n].childNodes.length
                  ? null
                  : Q(a[n].childNodes, g ? g.transclude : b)),
              k.push(g),
              k.push(l),
              (p = p || g || l),
              (g = null);
            ...
            case 1:
              ...
              for (var t = 0, C = l && l.length; t < C; t++) {
                ...
                if (!E || 8 <= E || m.specified) {
                  ...
                  c[n] = m = aa(
                    E && "href" == p
                      ? decodeURIComponent(a.getAttribute(p, 2))
                      : m.value
                  );
                  dc(a, n) && (c[n] = !0);
                  I(a, b, m, n);
        ...
        function M(a, c, d, e, g, f, l, p, n) {
          ...
          function K(a, e, g, f, n) {
            ...
            if (Q) {
              ...
              f = x(g);
              J = e.$new(!0);
              M && M === Q.$$originalDirective
                ? f.data("$isolateScope", J)
                : f.data("$isolateScopeNoTemplate", J);
          ...
          var Y = -Number.MAX_VALUE,
            u,
            Z = n.controllerDirectives,
            Q = n.newIsolateScopeDirective,
            M = n.templateDirective;
          ...
          for (
            ...
            if ((v = F.scope))
              (u = u || F),
                F.templateUrl ||
                  (H("new/isolated scope", Q, F, s), U(v) && (Q = F));
            ea = F.name;
            !F.templateUrl &&
              F.controller &&
              ((v = F.controller),
              (Z = Z || {}),
              H("'" + ea + "' controller", Z[ea], F, s),
              (Z[ea] = F));
            if ((v = F.transclude))
              (la = !0),
                F.$$tlb || (H("transclusion", n, F, s), (n = F)),
                "element" == v
                  ? ((Ha = !0),
                    (Y = F.priority),
                    (v = $(c, xa, gb)),
                    (s = d.$$element = x(
                      N.createComment(" " + ea + ": " + d[ea] + " ")
                    )),
                    (c = s[0]),
                    R(g, x(ua.call(v, 0)), c),
                    (w = y(v, e, Y, f && f.name, {
            ...
            if (F.template)
              if (
                (H("template", M, F, s),
                (M = F),
                (v = A(F.template) ? F.template(s, d) : F.template),
                (v = ic(v)),
                F.replace)
              ) {
                f = F;
            ...
            if (F.templateUrl)
              H("template", M, F, s),
                (M = F),
                F.replace && (f = F),
                (K = z(a.splice(I, a.length - I), s, d, g, w, l, p, {
              ...
              try {
                (G = F.compile(s, d, w)),
                  A(G) ? B(null, G, xa, gb) : G && B(G.pre, G.post, xa, gb);
              } catch (W) {
                m(W, ha(s));
              }
          ...
          if (c.hasOwnProperty(e)) {
            ...
            for (var C = 0, B = e.length; C < B; C++)
              try {
                (t = e[C]),
                  (f === r || f > t.priority) &&
                    -1 != t.restrict.indexOf(g) &&
                    (n && (t = Rb(t, { $$start: n, $$end: p })),
                    b.push(t),
                    (k = t));
              } catch (y) {
                m(y);
        ...
        function z(a, b, c, d, e, g, f, k) {
          ...
          b.empty();
          n.get(u.getTrustedResourceUrl(P), { cache: p })
            .success(function(n) {
              var p, K;
              n = ic(n);
              if (B.replace) {
                  ...
                  pre: function(c, d, l) {
                    ...
                    if ((g = b(l[e], !0, G(a, e))))
                      (l[e] = g(c)),
                        ((d[e] || (d[e] = [])).$$inter = !0),
                        (
                          (l.$$observers && l.$$observers[e].$$scope) ||
                          c
        ...
        Eb.prototype = {
          ...
          $set: function(a, b, c, d) {
            ...
            d
              ? (this.$attr[a] = d)
              : (d = this.$attr[a]) || (this.$attr[a] = d = cb(a, "-"));
            e = Ga(this.$$element);
    ...
    this.$get = [
      ...
      function(a, b, c, d, n, p) {
        function t(a) {
          ...
          (a = Fb(d.url)
            ? b.cookies()[d.xsrfCookieName || e.xsrfCookieName]
            : r) && (g[d.xsrfHeaderName || e.xsrfHeaderName] = a);
          var f = [
              function(a) {
                g = a.headers;
        ...
        function C(b, c, g) {
          ...
          C.then(k, k);
          (b.cache || e.cache) &&
            !1 !== b.cache && "GET" == b.method &&
            (u = U(b.cache) ? b.cache : U(e.cache) ? e.cache : K);
          if (u)
            if (((q = u.get(r)), z(q))) {
  ...
  function od(b, a, c, d, e) {
    ...
    return function(e, l, k, m, n, p, t, C) {
      ...
      if ("jsonp" == v(e)) {
        ...
        var r = g(
          l.replace("JSON_CALLBACK", "angular.callbacks." + P),
          function() {
      ...
      function(c, d, e) {
        function g(g, k, m) {
          for (var n, p, t = 0, C = [], B = g.length, K = !1, u = []; t < B; )
            -1 != (n = g.indexOf(b, t)) && -1 != (p = g.indexOf(a, n + f))
              ? (t != n && C.push(g.substring(t, n)),
                C.push((t = c((K = g.substring(n + f, p))))),
                (t.exp = K),
                (t = p + h),
                (K = !0))
              : (t != B && C.push(g.substring(t)), (t = B));
      ...
      function(b, a, c) {
        function d(d, f, h, l) {
          ...
          p.$$intervalId = k(function() {
            ...
            0 < h &&
              t >= h &&
              (n.resolve(t), m(p.$$intervalId), delete e[p.$$intervalId]);
            C || b.$apply();
          }, f);
          e[p.$$intervalId] = n;
          return p;
  ...
  function ud() {
    ...
    this.$get = [
      ...
      function(c, d, e, g) {
        ...
        a
          ? ((l =
              k.substring(0, k.indexOf("/", k.indexOf("//") + 2)) + (l || "/")),
            (e = e.history ? rc : sc))
          : ((l = Wa(k)), (e = Ib));
        h = new e(l, "#" + b);
        h.$$parse(h.$$rewrite(k));
        g.on("click", function(a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            ...
            var e = b.prop("href"),
              f = h.$$rewrite(e);
            e &&
              !b.attr("target") && f && !a.isDefaultPrevented() &&
              (a.preventDefault(),
              f != d.url() &&
                (h.$$parse(f),
                c.$apply(),
        ...
        d.onUrlChange(function(a) {
          h.absUrl() != a &&
            (c.$broadcast("$locationChangeStart", a, h.absUrl())
              .defaultPrevented
              ? d.url(h.absUrl())
  ...
  function vc(b, a, c) {
    ...
    if (a.csp)
      g =
        6 > e
          ? uc(d[0], d[1], d[2], d[3], d[4], c, a)
          : function(b, g) {
              var f = 0,
                h;
              do
                (h = uc(d[f++], d[f++], d[f++], d[f++], d[f++], c, a)(b, g)),
                  (g = r),
                  (b = h);
              while (f < e);
              return h;
      ...
      function(d, e, g, f) {
        ...
        h.prototype = {
          ...
          $watch: function(a, b, d) {
            var e = k(a, "watch"),
              g = this.$$watchers,
              f = { fn: b, last: m, get: e, exp: a, eq: !!d };
            c = null;
            if (!A(b)) {
  ...
  function Ed() {
    this.$get = [
      ...
      function(b, a) {
        var c = {},
          d = R(
            (/android (\d+)/.exec(v((b.navigator || {}).userAgent)) || [])[1]
          ),
        ...
        if (k) {
          ...
          !d ||
            (m && n) ||
            ((m = D(g.body.style.webkitTransition)),
  ...
  function Ac(b) {
    ...
    return function(b, d) {
      ...
      return Ec(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  function Bc(b) {
    ...
    return function(c, e) {
      ...
      for (; e; )
        (l = Nd.exec(e))
          ? ((f = f.concat(ua.call(l, 1))), (e = f.pop()))
          : (f.push(e), (e = null));
      q(f, function(a) {
        h = Od[a];
        g += h
      ...
      c = Pc(c, function(a) {
        ...
        return e(function(a, b) {
          ...
          var e = d(b),
            ...
            g = typeof e;
          f == g
            ? ("string" == f && ((c = c.toLowerCase()), (e = e.toLowerCase())),
              (c = c === e ? 0 : c < e ? -1 : 1))
            : (c = f < g ? -1 : 1);
          return c;
        }, c);
    ...
    if (c.ngMaxlength) {
      ...
      e = function(a) {
        if (!d.$isEmpty(a) && a.length > t)
          return d.$setValidity("maxlength", !1), r;
  ...
  var v = function(b) {
    ...
    Na = G("ng"),
    Pa = W.angular || (W.angular = {}),
    Va,
    Ga,
    ja = ["0", "0", "0"];
  E = R((/msie (\d+)/.exec(v(navigator.userAgent)) || [])[1]);
  isNaN(E) &&
    (E = R((/trident\/.*; rv:(\d+)/.exec(v(navigator.userAgent)) || [])[1]));
  s.$inject = [];
  Ba.$inject = [];
  var aa = (function() {
  ...
  var Tc = /[A-Z]/g,
    ...
    Xc = 1,
    Hc = W.document.addEventListener
      ? function(b, a, c) {
    ...
    Ab = W.document.removeEventListener
      ? function(b, a, c) {
    ...
    Fa = (I.prototype = {
      ready: function(b) {
        ...
        "complete" === N.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), I(W).on("load", a));
      },
      toString: function() {
        var b = [];
        q(this, function(a) {
        ...
        q(d.split(" "), function(d) {
          ...
          if (!g) {
            if ("mouseenter" == d || "mouseleave" == d) {
              var m =
                N.body.contains || N.body.compareDocumentPosition
                  ? function(a, c) {
  ...
  Kb.prototype = {
    ...
    lex: function(a) {
      ...
      for (a = []; this.index < this.text.length; ) {
        ...
        if (this.is("\"'")) this.readString(this.ch);
          ...
          this.readIdent(),
            this.was("{,") &&
              "{" === a[0] && (c = this.tokens[this.tokens.length - 1]) &&
              (c.json = -1 === c.text.indexOf("."));
        else if (this.is("(){}[].,;:?"))
          this.tokens.push({
            index: this.index,
            text: this.ch,
          ...
          var d = this.ch + this.peek(),
            ...
            h = Ka[e];
          h
            ? (this.tokens.push({ index: this.index, text: e, fn: h }),
              (this.index += 3))
            : f
            ? (this.tokens.push({ index: this.index, text: d, fn: f }),
              (this.index += 2))
            : g
            ? (this.tokens.push({
                index: this.index,
    ...
    readIdent: function() {
      for (
        var a = this, c = "", d = this.index, e, g, f, h;
      ...
      f &&
        ...
        this.tokens.push({ index: e + 1, text: f, json: !1 }));
    },
  ...
  Ya.prototype = {
    ...
    expect: function(a, c, d, e) {
      return (a = this.peek(a, c, d, e))
        ? (this.json && !a.json && this.throwError("is not valid json", a),
          this.tokens.shift(),
          a)
        : !1;
    },
    ...
    unary: function() {
      ...
      return this.expect("+")
        ? this.primary()
        : (a = this.expect("-"))
        ? this.binaryFn(Ya.ZERO, a.fn, this.unary())
        : (a = this.expect("!"))
    ...
    objectIndex: function(a) {
      ...
      return w(
        function(e, g) {
          ...
          if (!f) return r;
          (f = Xa(f[h], c.text)) &&
            f.then && c.options.unwrapPromises &&
            ((l = f),
            "$$v" in f ||
              ((l.$$v = r),
              l.then(function(a) {
      ...
      function(a, c, d, e, g) {
        ...
        this.$setValidity = function(a, c) {
          n[a] !== !c &&
            (c
              ? (n[a] && m--,
                m || (f(!0), (this.$valid = !0), (this.$invalid = !1)))
              : (f(!1), (this.$invalid = !0), (this.$valid = !1), m++),
            (n[a] = !c),
            f(c, a),
      ...
      function(a, c) {
        ...
        return {
          ...
          link: function(e, g, f) {
            ...
            q(f, function(a, c) {
              r.test(c) &&
                (m[v(c.replace("when", "").replace("Minus", "-"))] = g.attr(
                  f.$attr[c]
                ));
            });
            q(m, function(a, e) {
        ...
        return {
          ...
          link: function(e, f, h, l) {
            ...
            function m(a, c, d) {
              ...
              a.$watch(function() {
                ta(e, d.$viewValue) || ((e = ga(d.$viewValue)), d.$render());
              });
              c.on("change", function() {
                a.$apply(function() {
                  var a = [];
            ...
            function n(e, f, g) {
              function h() {
                ...
                for (J = 0; (H = B.length), J < H; J++) {
                  ...
                  v
                    ? (d = z(r.remove(u ? u(e, A) : q(e, A))))
                    : (u
                        ? ((d = {}), (d[m] = s), (d = u(e, d) === u(e, A)))
                        : (d = s === q(e, A)),
                      (r = r || d));
                  E = l(e, A);
                  E = z(E) ? E : "";
                    ...
                    (r = k[J]),
                      (d = x[J + 1])
                        ? ((E = d.element),
                          ...
                          E[0].selected !== r.selected &&
                            E.prop("selected", (d.selected = r.selected)))
                        : ("" === r.id && w
                            ? (I = w)
                            : (I = D.clone())
                                .val(r.id)
                          ...
                          E ? E.after(I) : s.element.append(I),
                          (E = I));
              ...
              var k;
              if (!(k = s.match(d))) throw De("iexp", s, ha(f));
              var l = c(k[2] || k[1]),
                m = k[4] || k[6],
                n = k[5],
                p = c(k[3] || ""),
            ...
            if (l[1]) {
              var p = l[0],
                ...
                w = !1,
                u,
                D = x(N.createElement("option")),
                G = x(N.createElement("optgroup")),
                y = D.clone();
              l = 0;
              ...
              if (v && (h.required || h.ngRequired)) {
                var E = function(a) {
                  t.$setValidity("required", !h.required || (a && a.length));
                  return a;
                };
                t.$parsers.push(E);
